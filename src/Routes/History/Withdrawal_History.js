...
const Withdrawal_History = () => {
    ...
    var [withdrawal_history,set_withdrawal_history]= new useState({
        ...
        rows:[
                {sr:'1',withdrawal_token:'500',txn:'View Txn',Date_Time:'12/11/2021 1:40:08 PM',Withdrawal_Amount:"$ 500",Withdrawal_Share_Pool:"$ 200",Withdrawal_Fees:"$ 100",Net_Amount:"$ 50"},
                {sr:'2',withdrawal_token:'500',txn:'View Txn',Date_Time:'12/11/2021 1:40:08 PM',Withdrawal_Amount:"$ 500",Withdrawal_Share_Pool:"$ 200",Withdrawal_Fees:"$ 100",Net_Amount:"$ 50"},
                {sr:'3',withdrawal_token:'500',txn:'View Txn',Date_Time:'12/11/2021 1:40:08 PM',Withdrawal_Amount:"$ 500",Withdrawal_Share_Pool:"$ 200",Withdrawal_Fees:"$ 100",Net_Amount:"$ 50"},
        ]});
    return ( 
        <div className="row justify-content-center" style={{height:'70vh'}}>
            <div className="col-md-11 py-3">
                <PagePath data={{page_name:"Main Wallet Withdrawal History",page_path:"Withdrawal / Main Wallet Withdrawal History"}} />
                <Table
                    data={currentPost}
